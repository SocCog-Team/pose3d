...
exp_name = 'Test_SM_SideA'; % ./AllExperiments/Experiment1; **This name is to be different for every new experiment**
...
nfeatures = 36; %Edit this to match your current experiment
...
ncams = 2; %Edit this to match your current experiment (minimum allowed value is 2)
...
primary2D_datafullpath     = {fullfile('/', 'Volumes', 'taskcontroller$', 'Projekts', 'DeepLabCut_Projects', 'ElmoTest20200630-CMJ-2020-06-30', 'videos', ...
	'SideA_hand_camera_top_right_45_SN19462593.20200619T124553.-0000.reindexed.clockDLC_resnet50_ElmoTest20200630Jun30shuffle1_1030000filtered.csv')}; 
...
secondary2D_datafullpath = [{fullfile('/', 'Volumes', 'taskcontroller$', 'Projekts', 'DeepLabCut_Projects', 'ElmoTest20200627-CMJ-2020-06-27', 'videos', ...
	'SideA_hand_camera_top_left_45_SN16306693.20200619T124553.-0000.reindexed.clockDLC_resnet50_ElmoTest20200627Jun27shuffle1_1030000filtered.csv')}];

                        
%% Calibration Specifics

squareSize = 21.1715; %%enter your checkboard square length in mm default is 24
...
calibvideos_primary = [{fullfile('/', 'Volumes', 'taskcontroller$', 'Projekts', 'DLC_MoCo_2020', 'Camera_calibration', 'CheckerBoard_20200710', ...
	'SideA_hand_camera_top_right_45_SN19462593.20200710T113036.-0000.reindexed.clock.avi')}];


%Every secondary camera must have one calibration video recorded
%simultaneously with primary camera
%this path can be anywhere that is readable by your user on the computer
calibvideos_secondary = [{fullfile('/', 'Volumes', 'taskcontroller$', 'Projekts', 'DLC_MoCo_2020', 'Camera_calibration', 'CheckerBoard_20200710', ...
	'SideA_hand_camera_top_left_45_SN16306693.20200710T113036.-0000.reindexed.clock.avi')}]; %path to your calibration video recorded from secondary camera 1 with primary
...
path_to_2Dtracked_video = fullfile('/', 'Volumes', 'taskcontroller$', 'Projekts', 'DeepLabCut_Projects', 'ElmoTest20200630-CMJ-2020-06-30', 'videos', ...
	'SideA_hand_camera_top_right_45_SN19462593.20200619T124553.-0000.reindexed.clock.avi');
...
color_bw = 0; % 1 if video/images of 2D tracked data is in color and 0 for black and white

nskip = 10; %(integer) min value nskip can take is 1, increase this when you have long recording (plots results from every nskip frames, however 3D reconstruction is done for all frames)
...
drawline = [1 2; 2 4; 4 9; 9 14; 2 5; 5 10; 10 15; 2 6; 6 11; 11 16; 2 7; 7 12; ...
12 17; 2 8; 8 13; 13 18; 19 20; 20 22; 22 27; 27 32; 20 25; 25 30; ...
30 35; 20 23; 23 28; 28 33; 20 24; 24 29; 29 34; 20 25; 25 30; 30 35; ...
20 26; 26 31; 31 36]; %0 : skeleton will not be drawn, Eg : [ 1 2; 2 3;], draws lines between features 1 and 2, 2 and 3 
...
ground_truth = ones([1, size(drawline, 1)]) * NaN ; 
