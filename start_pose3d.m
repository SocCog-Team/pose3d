function [ output_args ] = start_pose3d( input_args )
%START_POSE3D Summary of this function goes here
...
% start pose3d
open('./Codes/template_config_file.m');

open('./Codes/main_pose3d_SCP01.m');
